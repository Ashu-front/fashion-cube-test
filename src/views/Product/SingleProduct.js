...
class SingleProduct extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      modalShow: false,
      login: true,
      productData: this.props.history.location.state.item,
      product: {
        imagePath:
          "https://mansisalhotra.com/wp-content/uploads/2022/09/233A2750-1-scaled-700x972.jpg",
      },
    };
  }
  componentDidMount() {
    ...
    console.log("historyxxx", this.state.productData);
  }
                    ...
                    <div className="single_product_thumbnails">
                      <ul>
                        {this.state.productData &&
                          this.state.productData.variants
                            .slice(0, 4)
                            .map((item, index) => (
                              <li
                                key={index}
                                onClick={() => this.handleThumbnailClick(item)}
                              >
                                <img
                                  src={item.imagePath}
                                  alt=""
                  ...
                  <div className="col-lg-9 image_col order-lg-2 order-1">
                    <div className="single_product_image">
                      <div
                        ...
                        style={{
                          backgroundImage: `url(${
                            this.state.pic || this.state.productData.imagePath
                          })`,
                        }}
                      />
                    </div>
            ...
            <div className="col-lg-5">
              <div className="product_details">
                <div className="product_details_title">
                  <h2>{this.state.productData.cardTitle}</h2>
                  <p>{this.state.productData.cardDesc}</p>
                </div>
